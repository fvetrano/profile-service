package it.eng.tim.profilo.controller.component;
...
public class DiagnosticsComponent implements Ordered {
	...
	private static final Logger logger = LoggerFactory.getLogger(it.eng.tim.profilo.controller.component.DiagnosticsComponent.class);
	
	
	@SuppressWarnings("unchecked")
	@Around("execution(* it.eng.tim.profilo.web.ProfileController.*(..))")
